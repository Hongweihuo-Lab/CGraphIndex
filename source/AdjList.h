...
public:
    ...
    std::vector<u64> GetNextVid(u64 id);
    std::vector<u64> GetPrevVid(u64 id);

    u64 __get_input_neighbors(u64 id, u64 *output_buf, u64 buf_size);
    u64 __get_output_neighbors(u64 id, u64 *output_buf, u64 buf_size);

    struct __encoding_state {
        u64 ofs, bits, st, sam, num;
        u64 prv_value;
        u64 encoded;
    };

    __encoding_state __iterative_get_input_neighbors(u64 id, u64 n, u64 *output_buf, u64 buf_size);
    __encoding_state __iterative_get_input_neighbors(const __encoding_state &prv_state, u64 id, u64 n, u64 *output_buf, u64 buf_size);

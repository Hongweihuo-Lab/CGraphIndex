...
R"(Usage: cgi_benchmark [-h] [<data_dir> <query> <input> <output> [max_num]]
  ...
  query      - allowed options: {"startup", "bfs", "page_rank", "serial_bfs", "serial_page_rank", "khops", "ic1", "ic2", "ic5", "ic9", "ic10", "ic13", "bi2", "bi3", "bi10", "bi12", "bi16", "bi19"}
...
static const std::vector<std::string_view> kAllowedQueryNames {
    "startup", "bfs", "page_rank", "serial_bfs", "serial_page_rank", "khops", "ic1", "ic2", "ic5", "ic9", "ic10", "ic13", "bi2", "bi3", "bi12", "bi10", "bi16", "bi19"
};
...
int main(int argc, const char* argv[]) {
    ...
    if (args.size() == 1 && (args.front() == "-h" || args.front() == "--help")) {
        ...
        if (std::find(kAllowedQueryNames.begin(), kAllowedQueryNames.end(), query) == kAllowedQueryNames.end()) {
            ...
            std::cerr << R"(allowed options: {"startup", "bfs", "page_rank", "serial_bfs", "serial_page_rank", "khops", "ic1", "ic2", "ic5", "ic9", "ic10", "ic13", "bi2", "bi3", "bi10", "bi12", "bi16", "bi19"})"
                      << "\n";
            return 0;
        }
